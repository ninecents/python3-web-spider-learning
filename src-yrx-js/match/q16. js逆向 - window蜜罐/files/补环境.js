  ...
  for (var o, a, s, l = 0, c = []; l < e[t(261)]; ) {
    switch (((a = e[t(237)](l)), (s = i.kukBH(l, 6)))) {
      ...
      case 1:
        try {
          "WhHMm" === i[t(198)] ||
            (true && c[t(246)](f[t(245)](i.pHtmC(2 & o, 3) | i.evetF(a, 4))));
            // khz
            // (n.g && c[t(246)](f[t(245)](i.pHtmC(2 & o, 3) | i.evetF(a, 4))));
        } catch (e) {
...
function getCookieM(__t) {
//   var __t = Date.parse(new Date()).toString();
  var result = btoa(__t);
  // console.log(result);
  return result;
}

console.log("getCookieM()", getCookieM('1738847686000'));

...
(window["url"] = "/api/match/1"),
  (request = function () {
    var int_date_ex_0x2268f9 = Date["parse"](new Date()) + 100000000,
      _0x57feae = oo0O0(int_date_ex_0x2268f9["toString"]()) + window["f"];

    const data_0x5d83a3 = {};
    (data_0x5d83a3["page"] = window["page"]),
      (data_0x5d83a3["m"] = _0x57feae + "\u4E28" + int_date_ex_0x2268f9 / 1000);
    var data_0xb89747 = data_0x5d83a3;
    $["ajax"]({
      url: window["url"],
      dataType: "json",
      async: false,
...
// console.log(hex_md5('1738701046000'))